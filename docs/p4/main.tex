...
% PAPER HEADER 
\markboth{GEIN-3, Algoritmos avanzados, Práctica 4, \today}{}
...
% PAPER TITLE 
\title{Búsqueda de Caminos Mediante MVC}
...
{\scriptsize \textbf{Vídeo} - \href{https://youtu.be/WuzV_vvDq-o}{\textcolor{blue}{ver vídeo}}}
}
