...
% El programa principal ejecutará la librería Mesurament.jar para medir un RATIO. Además, se ejecutará una configuración predeterminada del programa a partir de un documento JSON. Creando las partes del programa como interficies y conectando el patrón mediante punteros.\bigskip

A continuación se explicarán cada uno de los módulos y como han sido adaptados y empleados en la práctica.

\input{MVC/Implementation/content}
