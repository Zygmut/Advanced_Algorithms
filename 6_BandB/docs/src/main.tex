...
% PAPER HEADER 
\markboth{GEIN-3, Algoritmos avanzados, Práctica 6, \today}{}
...
% PAPER TITLE 
\title{Solución del ``Puzzle 15'' de Tamaños Variables Mediante B\&B}
...
{\scriptsize \textbf{Vídeo} - \href{https://youtu.be/bRAbhJWalvo}{\textcolor{blue}{ver vídeo}}}
}
