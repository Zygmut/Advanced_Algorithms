	...
	public void notifyRequest(Request<?> request) {
		switch (request.code) {
			case GENERATE_UNIFORM_DATA, GENERATE_GAUSSIAN_DATA,
					GENERATE_EXPONENTIAL_DATA, GENERATE_BERNOULLI_DATA, SEND_DATA, CALC_MIN_DIS,
			...
			case NEW_DATA, NEW_PAIR_DATA_MIN, NEW_PAIR_DATA_MAX, NEW_PAIR_DATA_MAX_NLOGN, NEW_PAIR_DATA_MIN_NLOGN,
					...
					CLEAR_SOLUTIONS, GET_ALGORITHM, CHANGE_ALGORITHM, CHANGE_AUTO_MODE, GET_AUTO_MODE, UPDATE_LAMBDA, GET_LAMBDA-> {
