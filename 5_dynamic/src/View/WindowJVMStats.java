...
public class WindowJVMStats {
	...
	private void calcStats() {
		...
		LongFunction<Long> toMB = n -> n / 1024 / 1024;
		this.memoryUsed.add(new JVMStatsData(currentDateTime, toMB.apply(memTotal - memFree)));
		this.memoryFree.add(new JVMStatsData(currentDateTime, toMB.apply(memFree)));
		this.memoryTotal.add(new JVMStatsData(currentDateTime, toMB.apply(memTotal)));
	}
